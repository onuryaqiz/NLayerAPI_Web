...

{
    ...
    options.SuppressModelStateInvalidFilter = true; // API'ın dönmüş olduğu filter'ı burada baskıladık . Ve kendi modelimizin(ValidateFilterAttribute)'un dönmesini sağladık.
    // MVC'de bunu yazmaya gerek yok .
});
...
builder.Services.AddAutoMapper(typeof(MapProfile)); // Service.cs'deki MApProfile'ı AutoMapper'e ekledik.
